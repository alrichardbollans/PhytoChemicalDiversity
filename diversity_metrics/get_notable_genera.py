...
def main():
    ...
    indices = ['MFAD', 'APWD', 'FAD', 'shannon', 'bc_shannon', 'simpson', 'pielou']
    ...
    diversity_df['pathway_mean'] = diversity_df[['shannon_scaled', 'bc_shannon_scaled', 'simpson_scaled', 'pielou_scaled']].mean(axis=1)
    ...
    diversity_df['distance_mean'] = diversity_df[['MFAD_scaled', 'APWD_scaled', 'FAD_scaled']].mean(axis=1)
    ...
    diversity_df['mean'] = diversity_df[
        ['shannon_scaled', 'bc_shannon_scaled', 'simpson_scaled', 'pielou_scaled', 'MFAD_scaled', 'APWD_scaled', 'FAD_scaled']].mean(axis=1)
