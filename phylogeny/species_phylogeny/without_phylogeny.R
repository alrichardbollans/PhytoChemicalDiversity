...
div_and_species_df = data.frame('method'=c(div_and_species$method), 'estimate'=c(div_and_species$estimate), 'statistic'=c(div_and_species$statistic), 'pvalue'= c(div_and_species$p.value))
